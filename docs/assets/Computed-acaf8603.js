import{_ as O,j as _,g as P,o as I,c as N,d as u,w as n,F as $,k as l,a as e,t as s,q as m,n as b,p as E,e as S}from"./index-5fefc914.js";import{E as w,a as y}from"./el-descriptions-item-84a34e89.js";import{_ as k}from"./CodeBlockDisplay-35fee805.js";import"./CodeBlock-f667b5da.js";const B=a=>(E("data-v-b61480d6"),a=a(),S(),a),D=B(()=>e("div",null,[l(" 1. computed返回的是一个只读的ref对象，其value属性为函数返回值"),e("br"),l(" 2. computed的响应式体现在computed函数会在其依赖的ref对象发生变化时重新执行"),e("br"),l(" 3. 如果在初始化时手动为computed设置getter和setter，那么computed的值不在为只读 ")],-1)),F={class:"btn-ctn"},V=`
<scripts setup>

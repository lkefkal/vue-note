import{_ as h,r as P,o as n,c as i,F as c,g,t,a as C,e as l,b as e,av as N,a2 as b,w as s}from"./index-9eba7189.js";import{E as $,a as k}from"./el-descriptions-item-552f52d1.js";import{C as B}from"./CodeBlock.vue_vue_type_style_index_0_scoped_43392a15_lang-fd3de574.js";const x={class:"container"},A={key:0},E={class:"code-block"};function y(p,d,u,a,r,I){const f=P("highlightjs");return n(),i("div",x,[(n(!0),i(c,null,g(p.info,({title:m,code:_,fileName:v})=>(n(),i(c,null,[m?(n(),i("h1",A,t(m),1)):C("",!0),l("div",E,[l("p",null,t(v),1),e(f,{code:_.replace(/scripts/g,"script"),autodetect:"",class:"code-text"},null,8,["code"])])],64))),256))])}const o=h(B,[["render",y],["__scopeId","data-v-43392a15"]]),D=l("p",{id:"usage"},"1. "+t("<parent></parent>")+"组件中添加"+t("<slot></slot>")+" 标签",-1),V=l("p",null,"2. 将想要被包裹在"+t("<parent></paren>")+" 的组件包在里面",-1),j=l("p",null,"1. "+t("<parent></parent>")+"组件中添加"+t('<slot name=""></slot>')+" 标签",-1),w=l("p",null,"2. 将想要被包裹在"+t("<parent></paren>")+" 的"+t("<template #abc></template>")+"写入 并用#或者v-slot=''具名",-1),F=l("p",null,"1.未具名插槽向插入的组件传参",-1),H=l("p",null,"具名插槽传参",-1),R={__name:"Slot",setup(p){return N(),(d,u)=>{const a=k,r=$;return n(),b(r,{title:"插槽",column:1,style:{"margin-top":"2rem"}},{default:s(()=>[e(a,{label:"用法"},{default:s(()=>[D,e(o,{info:[{fileName:"Parent.vue",code:`
            <template>
              <div>
                <slot></slot>
              </div>

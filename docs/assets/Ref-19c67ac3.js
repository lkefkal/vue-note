var b=Object.defineProperty;var B=(u,e,t)=>e in u?b(u,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):u[e]=t;var p=(u,e,t)=>(B(u,typeof e!="symbol"?e+"":e,t),t);import{_ as E}from"./PCodeBlockDisplay-078fc664.js";import{V as v,O as A,_ as D,o as h,c as g,b as c,w as s,F as y,h as l,t as _,e as r,p as O,d as P}from"./index-3405d147.js";import{E as k}from"./el-button-b1bdf878.js";import{E as w,a as I}from"./el-descriptions-item-ef5f4155.js";import"./PCodeBlock-8b9617ef.js";import"./use-form-common-props-8713072b.js";var R=Object.defineProperty,V=Object.getOwnPropertyDescriptor,$=(u,e,t,a)=>{for(var o=a>1?void 0:a?V(e,t):e,F=u.length-1,n;F>=0;F--)(n=u[F])&&(o=(a?n(e,t,o):n(o))||o);return a&&o&&R(e,t,o),o};let i=class extends v{constructor(){super(...arguments);p(this,"count",0);p(this,"incresement",()=>{this.count+=1});p(this,"decresement",()=>{this.count-=1})}get code(){return`
        <scripts setup>
        import { ref } from 'vue';
        const count = ref(0)
        const incresement = () => {
